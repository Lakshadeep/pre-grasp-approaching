...
from mushroom_rl.algorithms.actor_critic import SAC, DDPG, PPO
from mushroom_rl.core import Core, Logger
from mushroom_rl.environments.gym_env import Gym
from mushroom_rl.utils.dataset import compute_J, parse_dataset

from pre_grasp_approaching.tasks.base_motion import BaseMotion
from pre_grasp_approaching.networks.base_motion import ActorNetwork, CriticNetwork
...
def experiment(cfg, alg):
    ...
    for n in trange(n_epochs, leave=False):
        ...
        if save_dir:
            if n % 10  == 0:
                agent.save('{}/base_motion_epoch_{}.msh'.format(save_dir, n), full_save=True)
        ...
        np.savez('{}/base_motion_data_logs.npz'.format(save_dir), full_save=True, J=J_mean_logs, 
